...
(function (factory) {
    ...
    Validator.MESSAGES = {
        // Types
        tel: 'Please enter a valid number (only digits).',
    ...
    $.extend(prototype, {
        ...
        // Alias of valid, as "âˆš"
        v: function () {
            return this.validate();
        },

        // Alias of invalid, as "Ã—"
        x: function () {
            return !this.validate();
        },
    ...
    $.extend(prototype, {
        tel: function (value) {
            return Validator.PATTERNS.tel.test(value);
        },
